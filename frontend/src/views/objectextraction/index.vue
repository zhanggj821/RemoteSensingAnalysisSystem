<template>
  <div class="app-container" style="overflow: auto;">
    ...
    <el-row style="text-align: center; padding-top:10px;padding-bottom:30px;">
      <el-button type="primary" round :loading="loading" @click="doObjectDetection()">目标检测</el-button>
    </el-row>
  ...
  methods: {
    ...
    saveResult() {
      ...
      if (tempData === '') {
        ...
        saveAs(tempResult, 'detecres.jpg')
      }
    },
    doObjectDetection() {
      var that = this
      ...
      if (that.dialogImageUrl1 === '') {
        ...
        axios.post('http://10.1.114.93:5000/v1/objectextraction',
          formData
        ).then((response) => {
          ...
          const src = 'data:image/jpeg;base64,' + response.data.extracres
          that.resultsrc = src
